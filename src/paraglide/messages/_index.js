...
*/
/* @__NO_SIDE_EFFECTS__ */
const hero_section_title = (inputs = {}, options = {}) => {
	if (experimentalMiddlewareLocaleSplitting && isServer === false) {
...
*/
/* @__NO_SIDE_EFFECTS__ */
const months_mar = (inputs = {}, options = {}) => {
	if (experimentalMiddlewareLocaleSplitting && isServer === false) {
...
*/
/* @__NO_SIDE_EFFECTS__ */
const months_may = (inputs = {}, options = {}) => {
	if (experimentalMiddlewareLocaleSplitting && isServer === false) {
...
*/
/* @__NO_SIDE_EFFECTS__ */
const months_jun = (inputs = {}, options = {}) => {
	if (experimentalMiddlewareLocaleSplitting && isServer === false) {
...
*/
/* @__NO_SIDE_EFFECTS__ */
const months_jul = (inputs = {}, options = {}) => {
	if (experimentalMiddlewareLocaleSplitting && isServer === false) {
...
*/
/* @__NO_SIDE_EFFECTS__ */
const months_oct = (inputs = {}, options = {}) => {
	if (experimentalMiddlewareLocaleSplitting && isServer === false) {
...
*/
/* @__NO_SIDE_EFFECTS__ */
const months_nov = (inputs = {}, options = {}) => {
	if (experimentalMiddlewareLocaleSplitting && isServer === false) {
...
*/
/* @__NO_SIDE_EFFECTS__ */
const months_dec = (inputs = {}, options = {}) => {
	if (experimentalMiddlewareLocaleSplitting && isServer === false) {
